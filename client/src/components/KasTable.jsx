...
import EnhancedTableToolbar from "./kasboek_screen/EnhancedTableToolbar";
import EnhancedTableHead from "./kasboek_screen/EnhancedTableHead";
...
export default function EnhancedTable(props) {
  ...
  if (!rows) {
    return <div>momenteel geen kasboek</div>;
  }
